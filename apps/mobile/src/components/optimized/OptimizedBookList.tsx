...
const ItemSeparator = React.memo(({ colors }: { colors: ReturnType<typeof useTheme>['colors'] }) => (
  <View style={[styles.separator, { backgroundColor: colors.border }]} />
));

ItemSeparator.displayName = 'ItemSeparator';

export const OptimizedBookList = React.memo(({ editionId: _editionId, onBookSelect }: BookListProps) => {
