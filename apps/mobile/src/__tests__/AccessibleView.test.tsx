...
describe('AccessibleView', () => {
  ...
  it('should apply accessibility role', () => {
    const { getByRole } = render(
      <AccessibleView accessibilityLabel="Test" accessibilityRole="button">
        <Text>Content</Text>
      </AccessibleView>
    );
  ...
  it('should apply accessibility hint', () => {
    const { getByHintText } = render(
      <AccessibleView accessibilityLabel="Test" accessibilityHint="Double tap to open">
        <Text>Content</Text>
      </AccessibleView>
    );
  ...
  it('should apply custom styles', () => {
    ...
    const { getByLabelText } = render(
      <AccessibleView accessibilityLabel="Styled view" style={customStyle}>
        <Text>Content</Text>
      </AccessibleView>
    );
  ...
  describe('accessibility roles', () => {
    it('should support button role', () => {
      const { getByRole } = render(
        <AccessibleView accessibilityLabel="Action button" accessibilityRole="button">
          <Text>Press me</Text>
        </AccessibleView>
      );
    ...
    it('should support text role', () => {
      const { getByRole } = render(
        <AccessibleView accessibilityLabel="Text content" accessibilityRole="text">
    ...
    it('should support header role', () => {
      const { getByRole } = render(
        <AccessibleView accessibilityLabel="Section header" accessibilityRole="header">
          <Text>Chapter 1</Text>
        </AccessibleView>
      );
    ...
    it('should support link role', () => {
      const { getByRole } = render(
        <AccessibleView accessibilityLabel="Cross reference link" accessibilityRole="link">
  ...
  describe('accessibility hints', () => {
    it('should provide actionable hints', () => {
      const { getByHintText } = render(
        <AccessibleView accessibilityLabel="Verse" accessibilityHint="Double tap to add bookmark">
  ...
  describe('style combinations', () => {
    it('should support array styles', () => {
      const styles = [{ padding: 10 }, { backgroundColor: '#fff' }, { marginTop: 20 }];

      const { getByLabelText } = render(
        <AccessibleView accessibilityLabel="Multi-style view" style={styles}>
          <Text>Content</Text>
        </AccessibleView>
      );
  ...
  describe('real-world usage', () => {
    ...
    it('should work as chapter header', () => {
      const { getByRole, getByText } = render(
        <AccessibleView accessibilityLabel="Chapter 3 heading" accessibilityRole="header">
          <Text>Chapter 3</Text>
        </AccessibleView>
      );
