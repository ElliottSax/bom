...
describe('OnboardingScreen', () => {
  beforeEach(() => {
    ...
    Object.keys(mockAsyncStorage).forEach(key => {
      require('@react-native-async-storage/async-storage')[key] =
        mockAsyncStorage[key];
    });
  ...
  describe('page content', () => {
    ...
    it('should show welcome message on final page', () => {
      ...
      expect(
        getByText(
          /You are ready to dive into the scriptures/
        )
      ).toBeTruthy();
    });
  });
  ...
  describe('error handling', () => {
    it('should handle AsyncStorage errors gracefully', async () => {
      mockAsyncStorage.setItem = jest.fn().mockRejectedValue(
