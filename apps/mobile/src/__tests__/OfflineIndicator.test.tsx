...
const mockUseNetworkStatus = require('../hooks/useNetworkStatus').useNetworkStatus as jest.Mock;
...
describe('OfflineIndicator', () => {
  ...
  describe('connection state', () => {
    ...
    it('should animate when connection changes', async () => {
      const _netInfoMock = createNetInfoMock({ isConnected: true, type: 'wifi' });
      mockUseNetworkStatus.mockReturnValue({ isConnected: true });
  ...
  describe('re-rendering', () => {
    ...
    it('should re-animate when connection state changes', () => {
      ...
      expect((Animated.timing as jest.Mock).mock.calls.length).toBeGreaterThan(callCount);
    });
  });
