...
export function createVerseShareData(verse: string, reference: string, url?: string): ShareData {
  return {
...
export function createCourseCompletionShareData(courseName: string, score?: number): ShareData {
