...
import { modalContent, tapPress } from '../../lib/motion';
    ...
    <AnimatePresence>
      {show && (
        <motion.div
          ...
          animate="visible"
          exit="exit"
          className="fixed right-4 top-16 z-50 bg-[var(--color-bg-primary)] rounded-xl shadow-xl border border-[var(--color-border)] p-4 w-72"
        >
