...
export const SearchModal: React.FC<SearchModalProps> = ({
  ...
  return (
    <div
      className="fixed inset-0 bg-black/50 z-50 flex items-start justify-center pt-20 fade-in"
      onClick={onClose}
      role="dialog"
      aria-modal="true"
      ...
      >
        <div className="p-4">
          <div className="relative">
            ...
            />
            <div className="absolute left-4 top-1/2 -translate-y-1/2 text-[var(--color-text-tertiary)]" aria-hidden="true">
              <SearchIcon />
            </div>
          </div>
        </div>
        <div className="max-h-96 overflow-y-auto">
          {error ? (
            ...
            <div className="p-8 text-center text-[var(--color-text-tertiary)]">No results found</div>
          ) : (
            <div className="p-8 text-center text-[var(--color-text-tertiary)]">Type to search scriptures</div>
          )}
        </div>
      </div>
    </div>
