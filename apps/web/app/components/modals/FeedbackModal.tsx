...
export default function FeedbackModal({ isOpen, onClose }: FeedbackModalProps) {
    ...
    try {
      ...
      if (typeof window !== 'undefined') {
        const feedbackHistory = JSON.parse(
          localStorage.getItem('coc-feedback-history') || '[]'
        );
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm" role="dialog" aria-modal="true" aria-labelledby="feedback-modal-title">
        ...
        {submitted ? (
          <div className="p-8 text-center" role="status" aria-live="polite">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Your feedback helps us improve the app for the Community of Christ
              community.
            </p>
          </div>
        ) : (
