...
export function ShareButton({
  ...
  const variantClasses = {
    ...
    secondary: 'bg-[var(--color-bg-secondary)] hover:bg-[var(--color-bg-tertiary)] text-[var(--color-text-primary)]',
    'icon-only': 'bg-transparent hover:bg-[var(--color-bg-secondary)] text-[var(--color-text-secondary)]',
  };
