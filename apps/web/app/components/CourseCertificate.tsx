...
import { modalOverlay, modalContent, hoverLift, tapPress } from '../lib/motion';
  ...
  <style>
    ...
    * {
    ...
    .certificate {
      ...
      border: 3px solid #C5A96E;
      box-shadow: 0 0 0 8px #fff, 0 0 0 11px #C5A96E, 0 4px 20px rgba(0,0,0,0.15);
      padding: 40px 50px;
      position: relative;
      display: flex;
    ...
    .divider {
      width: 200px;
      height: 2px;
      background: linear-gradient(90deg, transparent, #C5A96E, transparent);
      margin: 15px 0;
    }
    ...
    .seal {
      ...
      justify-content: center;
      margin: 0 auto;
      background: linear-gradient(135deg, #ffffff 0%, #F0E2BE 100%);
    }
...
<body>
  <div class="certificate">
    ...
    <div class="footer">
      ...
      <div class="organization">Community of Christ Courses</div>
    </div>
  </div>
</body>
</html>
  ...
  return (
    ...
    >
      <motion.div
        ...
        animate="visible"
        exit="exit"
        className="bg-[var(--color-bg-primary)] rounded-lg shadow-xl max-w-2xl w-full"
      >
        {/* Header */}
        <div className="flex items-center justify-between p-4 border-b border-[var(--color-border-light)]">
          <h2 className="text-xl font-bold text-[var(--color-text-primary)]">Course Completed!</h2>
          <button
            onClick={onClose}
        ...
        {/* Certificate Preview */}
        <div className="p-6">
          <div className="bg-gradient-to-br from-gold-50 to-gold-100 dark:from-gold-900/20 dark:to-gold-800/20 border-2 border-gold-300 dark:border-gold-600 rounded-lg p-8 text-center">
            {/* Decorative Border */}
            <div className="relative">
              ...
              {/* Title */}
              <h3 className="text-2xl font-serif font-bold text-gold-800 dark:text-gold-300 tracking-wide mb-1">
                CERTIFICATE
              </h3>
              <p className="text-sm text-gold-600 dark:text-gold-400 tracking-widest uppercase mb-6">
                of Completion
              </p>
              ...
              {/* Seal */}
              <div className="mt-6 inline-flex items-center justify-center w-16 h-16 rounded-full border-2 border-gold-400 bg-gradient-to-br from-gold-100 to-gold-200 dark:from-gold-800/30 dark:to-gold-700/30">
                <svg
          ...
          <div className="flex items-center justify-center gap-4 mt-6">
            <motion.button
              ...
              whileTap={tapPress}
              onClick={handlePrint}
              className="flex items-center gap-2 px-6 py-3 bg-gold-500 hover:bg-gold-600 text-white font-semibold rounded-lg transition-colors"
            >
