...
import { useCourseProgress, type CourseProgressData, type QuizScore } from '../contexts/CourseProgressContext';
...
function StatCard({ icon, label, value, subtext, color }: StatCardProps) {
  ...
  return (
    <div className="bg-[var(--color-bg-primary)] rounded-lg p-4 border border-[var(--color-border-light)]">
