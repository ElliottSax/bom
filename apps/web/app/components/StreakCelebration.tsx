  ...
  return (
    ...
    >
      ...
      >
        ...
        `}
        >
          <h2 className="text-3xl font-bold text-white mb-2 animate-bounce">{milestone.title}</h2>
          <p className="text-6xl font-black text-white drop-shadow-lg">{streak}</p>
          <p className="text-xl text-white font-semibold mt-2">Days in a Row!</p>
        </div>

        {/* Message */}
        <div className="p-8 text-center">
          <p className="text-lg text-[var(--color-text-secondary)] mb-6">{milestone.message}</p>
