...
import { getDifficultyColor, getDifficultyBgColor, type Challenge, type UserChallenge } from '../lib/challenges';
...
export function ChallengeCard({ challenge, onJoin, onView, variant = 'available' }: ChallengeCardProps) {
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              <span className={`text-xs px-2 py-0.5 rounded-full ${difficultyBgColor} ${difficultyColor} font-medium capitalize`}>
        ...
        <div className="mb-4">
          ...
          <div className="grid grid-cols-3 gap-2 mt-3 text-xs">
            <div>
              ...
              <p className="font-semibold">{userChallenge.progress.chaptersRead}/{challenge.targetChapters}</p>
            </div>
            <div>
  ...
  return (
    <div className="bg-gradient-to-br from-blue-500/10 to-purple-500/10 border border-blue-500/30 rounded-lg p-3">
      ...
      <div className="flex justify-between text-xs">
        <span className="text-[var(--color-text-tertiary)]">{challenge.percentComplete}% complete</span>
        <span className="font-semibold">{challenge.progress.chaptersRead}/{challenge.targetChapters}</span>
      </div>
    </div>
  );
}
