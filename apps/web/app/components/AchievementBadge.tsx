...
import { type Achievement, getRarityColor, getRarityBgColor, getAchievementProgress } from '../lib/achievements';
...
export function AchievementBadge({
  ...
  const progress = userData && !unlocked
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <h3 className={`font-bold text-sm ${rarityColor}`}>
            {achievement.name}
          </h3>
