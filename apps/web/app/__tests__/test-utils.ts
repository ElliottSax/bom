...
export function createMockVerse(overrides?: Partial<{
  id: string;
  verseId: string;
  book: string;
  chapter: number;
...
export function createMockGoal(overrides?: Partial<{
  id: string;
...
export function createMockMemorizationVerse(overrides?: Partial<{
  id: string;
  verseId: string;
  book: string;
  chapter: number;
