...
describe('useCrossReferences', () => {
  describe('getCrossReferences', () => {
    it('should return cross references for a verse', () => {
      ...
      const refs = result.current.getCrossReferences('coc-bom-1908', 'I Nephi', 3, 7);
    ...
    it('should return empty array for verses without cross references', () => {
      ...
      const refs = result.current.getCrossReferences('coc-bom-1908', 'I Nephi', 1, 1);
    ...
    it('should return multiple cross references for Sermon on the Mount', () => {
      ...
      const refs = result.current.getCrossReferences('coc-bom-1908', 'III Nephi', 12, 3);
    ...
    it('should handle Isaiah quotations', () => {
      ...
      const refs = result.current.getCrossReferences('coc-bom-1908', 'II Nephi', 12, 1);
  ...
  describe('getChapterCrossReferences', () => {
    it('should return all cross references in a chapter', () => {
      ...
      const chapterRefs = result.current.getChapterCrossReferences('coc-bom-1908', 'III Nephi', 12);
    ...
    it('should return empty map for chapter without cross references', () => {
      ...
      const chapterRefs = result.current.getChapterCrossReferences('coc-bom-1908', 'I Nephi', 1);
  ...
  describe('hasCrossReferences', () => {
    it('should return true for verses with cross references', () => {
      ...
      const hasRefs = result.current.hasCrossReferences('coc-bom-1908', 'I Nephi', 3, 7);
    ...
    it('should return false for verses without cross references', () => {
      ...
      const hasRefs = result.current.hasCrossReferences('coc-bom-1908', 'I Nephi', 1, 1);
  ...
  describe('cross reference data integrity', () => {
    it('should have valid verse IDs for all references', () => {
      ...
      const refs1 = result.current.getCrossReferences('coc-bom-1908', 'Moroni', 10, 4);
      expect(refs1.length).toBeGreaterThan(0);

      const refs2 = result.current.getCrossReferences('coc-bom-1908', 'Alma', 32, 21);
    ...
    it('should have correct types for Bible parallels', () => {
      ...
      const beatitudeRefs = result.current.getCrossReferences('coc-bom-1908', 'III Nephi', 12, 3);
    ...
    it('should have correct types for Isaiah quotes', () => {
      ...
      const isaiahRefs = result.current.getCrossReferences('coc-bom-1908', 'II Nephi', 12, 1);
