...
describe('FeedbackModal', () => {
  ...
  describe('rendering', () => {
    it('should render when open', () => {
      const { getByText } = render(<FeedbackModal isOpen={true} onClose={jest.fn()} />);

      expect(getByText('Send Feedback')).toBeInTheDocument();
    });

    it('should not render when closed', () => {
      const { queryByText } = render(<FeedbackModal isOpen={false} onClose={jest.fn()} />);

      expect(queryByText('Send Feedback')).not.toBeInTheDocument();
    });

    it('should render feedback textarea', () => {
      const { getByPlaceholderText } = render(<FeedbackModal isOpen={true} onClose={jest.fn()} />);

      expect(getByPlaceholderText(/Share your thoughts/i)).toBeInTheDocument();
    });
    ...
    it('should render submit button', () => {
      const { getByRole } = render(<FeedbackModal isOpen={true} onClose={jest.fn()} />);
  ...
  describe('user input', () => {
    it('should allow typing in feedback textarea', () => {
      ...
      const textarea = getByPlaceholderText(/Share your thoughts/i) as HTMLTextAreaElement;
    ...
    it('should allow typing in email input', () => {
      ...
      const emailInput = getByPlaceholderText(/your@email.com/i) as HTMLInputElement;
  ...
  describe('close functionality', () => {
    it('should call onClose when close button is clicked', () => {
      ...
      const { getByRole } = render(<FeedbackModal isOpen={true} onClose={onCloseMock} />);
    ...
    it('should clear form when closing', async () => {
      ...
      const newTextarea = getByPlaceholderText(/Share your thoughts/i) as HTMLTextAreaElement;
  ...
  describe('feedback history', () => {
    it('should limit feedback history to last 10 items', async () => {
      ...
      localStorageMock.setItem('coc-feedback-history', JSON.stringify(existingHistory));
